    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="物品特征" prop="wupintezheng">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="物品特征"
                  v-model="ruleForm.wupintezheng" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wupintezheng" label="物品特征" prop="wupintezheng">
                    <span>{{ruleForm.wupintezheng}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
