<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="表白时间" prop="biaobaishijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.biaobaishijian" 
                type="date"
                :readonly="ro.biaobaishijian"
                placeholder="表白时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.biaobaishijian" label="表白时间" prop="biaobaishijian">
              <el-input v-model="ruleForm.biaobaishijian" 
                placeholder="表白时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.biaobaishijian = this.getCurDate()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='biaobaishijian'){
            this.ruleForm.biaobaishijian = obj[o];
	    this.ro.biaobaishijian = true;
            continue;
          }
          if(o=='yonghuzhanghao'){
