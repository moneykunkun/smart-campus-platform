...
public class XiaoyuanjianzhiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public XiaoyuanjianzhiEntity() {
		
	}
	
	public XiaoyuanjianzhiEntity(T t) {
		try {
	 ...
	 * 设置：兼职编号
	 */
	public void setJianzhibianhao(String jianzhibianhao) {
		this.jianzhibianhao = jianzhibianhao;
	}
	/**
	 * 获取：兼职编号
	 */
	public String getJianzhibianhao() {
