...
public class ShiwuzhaolingController {
    ...
    public R page(@RequestParam Map<String, Object> params,ShiwuzhaolingEntity shiwuzhaoling,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date shiqushijianstart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date shiqushijianend,
        ...
        EntityWrapper<ShiwuzhaolingEntity> ew = new EntityWrapper<ShiwuzhaolingEntity>();
                if(shiqushijianstart!=null) ew.ge("shiqushijian", shiqushijianstart);
                if(shiqushijianend!=null) ew.le("shiqushijian", shiqushijianend);
